...
describe('SmoothieCard', () => {
    ...
    // Test case to check that the SmoothieCard component renders the correct smoothie ingredients
    it('renders the correct smoothie ingredients', () => {
        // Render the SmoothieCard component
        const { getByText } = render(<SmoothieCard smoothie={{title: 'Smoothie', allergens: 'nuts', ingredients: 'banana, milk, nuts', rating: 4}} />);
        // Check that the SmoothieCard component renders the correct smoothie ingredients
        expect(getByText('banana, milk, nuts')).toBeInTheDocument();
    });
